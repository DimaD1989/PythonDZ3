...
# *Верните все возможные варианты комплектации рюкз


subject = { "тушенка": 2, "спички": 1, "чай": 5, "обувь": 3, "палатка": 10}
def backpack_capacity(capacity:int, subject: dict)-> list[str]:
    packing = []
    summary = []
...
print(backpack_capacity(15,subject))
